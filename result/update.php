...
?>
	...
	NO :<input type="number" placeholder="ROLL NO" name="noget" min="1" maxmum="10">
	</br><br>
	
	NEW NO :<input type="number" placeholder="ROLL NO" name="newnoget" min="1" maxmum="10">
	</br><br>
	
	NAME:<input type="text" placeholder="NAME" name="nameget">
